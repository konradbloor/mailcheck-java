...
public class Sift3 implements DistanceAlgorithm {
	 ...
	 */
	public Sift3(final int maxOffset) {
		this.maxOffset = maxOffset;
	}

	@Override
	public float getDistance(final String firstString, final String secondString) {
	...
	private boolean isNullOrEmpty(final String candidate) {
